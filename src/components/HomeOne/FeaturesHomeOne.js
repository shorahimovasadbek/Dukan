...
function FeaturesHomeOne({ className }) {
    ...
    return (
        <section className={`appie-features-area pb-100 pt-100 ${className}`} id="industries">
                                ...
                                {data.map(item => {
                                    return (
                                        <a
                                            ...
                                            className={`nav-link ${tab === `${item.name}` ? 'active' : ''}`}
                                            id="v-pills-home-tab"
                                            data-toggle="pill"
                                            href="#v-pills-home"
                                            role="tab"
                    ...
                    <div className="col-lg-8">
                        <div className="tab-content" id="v-pills-tabContent">
                            {data.map((item,index) => {
                                return (
                                    <div
                                        className={`${tab === `${item.name}` ? 'show active' : ''} tab-pane fade`}
                                        id="v-pills-profile"
                                        role="tabpanel"
                                        ...
                                        <div className="row align-items-center">
                                            ...
                                            <div className="col-lg-6">
                                                ...
                                                >
                                                    ...
                                                    <h3 className="title">
                                                        {item.name} biznesingiz uchun veb-platforma sotib olish (2024)
                                                    </h3>
                                                    <p>
                                                        {/* {item.text} */}
                                                        2024 yilda biz tarmoqda mavjudligimiz va mijozlar tajribasini yaxshilash uchun veb-platforma.
                                                    </p>
